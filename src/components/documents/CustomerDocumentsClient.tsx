  ...
  return (
    <main className="mx-auto min-h-[60vh] max-w-5xl px-4 py-10">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Download receipts, invoices and return documents for your orders.
      </p>
          ...
          >
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {document.type.replace(/_/g, " ")} · Order {document.orderNumber} ·{" "}
                {new Date(document.issuedAt).toLocaleDateString("en-IN")}
              </p>
            </div>
            <button
